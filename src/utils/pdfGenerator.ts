...
<body>
  <div class="header">
    <h1>&#x1F9F5; गुड्डू पप्पु रंगाई</h1>
    <p>पितांबरी रंगाई — बिल / रसीद</p>
  </div>

  <div class="bill-meta">
    <div class="meta-box">
      <div class="meta-label">ग्राहक</div>
      <div class="meta-value">${bill.customerName}</div>
    </div>
    <div class="meta-box">
      <div class="meta-label">कपड़े की तारीख</div>
      <div class="meta-value">${bill.dateLabel ?? formatDisplayDate(bill.receivedDate)}</div>
    </div>
    <div class="meta-box">
      <div class="meta-label">बिल जनरेट किया गया</div>
  ...
  <div class="grand-total">
    <div class="label">कुल देय राशि</div>
    <div class="amount">₹${bill.grandTotal.toFixed(2)}</div>
  </div>

  <div class="footer">
    <p>Generated by गुड्डू पप्पु रंगाई &bull; ${new Date().toLocaleDateString('en-IN')} &bull; Thank you!</p>
  </div>
</body>
</html>`;
}
